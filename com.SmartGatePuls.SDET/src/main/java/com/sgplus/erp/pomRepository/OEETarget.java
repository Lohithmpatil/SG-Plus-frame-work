...
public class OEETarget {
	...
	// Constructor
	public OEETarget(WebDriver driver) {
		this.driver = driver;
...
// WebElements - identified using @FindBy
	@FindBy(xpath = "//div[@title=\"OEE Target\"]")
	private WebElement OEETargetPage;

	/* ================= FILTER ================= */

	public WebElement getOEETargetPage() {
		return OEETargetPage;
	}
	...
	@FindBy(xpath = "//input[@placeholder='OEE']")
	private WebElement OEETargetTextFeild;


	public WebElement getOEETargetTextFeild() {
		return OEETargetTextFeild;
	}
