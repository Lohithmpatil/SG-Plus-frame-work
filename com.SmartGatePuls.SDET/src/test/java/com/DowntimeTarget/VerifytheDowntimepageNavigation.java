...
public class VerifytheDowntimepageNavigation extends BaseClass {

	@Test
	public void VerifytheDowntimepageNavigation() throws Throwable {
		...
		WebElement cycleTimeHeader = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()=\"Settings/Downtime Target\"]")));

		Assert.assertTrue(cycleTimeHeader.isDisplayed(), "Settings/Downtime Target header is not displayed");
	}
