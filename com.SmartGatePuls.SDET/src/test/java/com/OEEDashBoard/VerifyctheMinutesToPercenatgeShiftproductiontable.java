...
public class VerifyctheMinutesToPercenatgeShiftproductiontable extends BaseClass{
	
	@Test
	public void VerifyctheMinutesToPercenatgeShiftproductiontable () throws Throwable {
   ...
   we.waitAndClick(oe.getMinutestoPercentageToggleButton());
