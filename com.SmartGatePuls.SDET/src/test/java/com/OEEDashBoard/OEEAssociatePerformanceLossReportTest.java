...
public class OEEAssociatePerformanceLossReportTest extends BaseClass {
	@Test
	public void OEEAssociatePerformanceLossReportTest() throws Throwable {
		...
		WebElement bestPerformanceTable = wait1.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//span[text()='Associate Performance Report']")));

		Assert.assertTrue(bestPerformanceTable.isDisplayed());

		System.out.println("Associate Performance Report table displayed successfully");
	}
