...
public class VerifytheShiftproductionreportPeriodwise extends BaseClass {

	@Test
	public void VerifytheShiftproductionreportPeriodwise() throws Throwable {
		...
		we.select(oe.getShiftProductionGropByDrodown(), "Period");
		...
		if (selectedOption.equals("Period")) {
