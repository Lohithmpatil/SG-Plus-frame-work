...
public class UserDeleteCancelFuctionality extends BaseClass {

	@Test
	public void UserDeleteCancelFuctionality() throws Throwable {
		...
		boolean popupClosed = wait
				.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[text()=\"Delete User\"]")));

		Assert.assertTrue(popupClosed, "Delete User Status popup did not close after clicking No Button");
