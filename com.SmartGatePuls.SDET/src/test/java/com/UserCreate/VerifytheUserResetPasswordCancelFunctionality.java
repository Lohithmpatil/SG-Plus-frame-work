...
public class VerifytheUserResetPasswordCancelFunctionality  extends BaseClass{
	

	@Test
	public void VerifytheUserResetPasswordCancelFunctionality() throws Throwable {
		...
		we.waitAndClick(us.getCancelNewPasswordButton());
		...
		Assert.assertTrue(popupClosed,
		        "Reset Password popup did not close after clicking Cancel");
