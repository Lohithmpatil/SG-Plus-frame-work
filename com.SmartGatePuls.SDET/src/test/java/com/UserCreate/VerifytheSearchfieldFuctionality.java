...
public class VerifytheSearchfieldFuctionality  extends BaseClass{
	
	// TestNG test method to verify Add Department Group functionality
		@Test
		public void VerifytheSearchfieldFuctionality() throws Throwable {
			...
			WebElement userRecord = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//td[contains(text(),'" + expectedUserName + "')]")));

			String actualUserName = userRecord.getText();
			...
			System.out.println("User displayed successfully in User List");
