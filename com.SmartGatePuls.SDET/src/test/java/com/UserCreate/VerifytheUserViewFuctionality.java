...
public class VerifytheUserViewFuctionality extends BaseClass {

	// TestNG test method to verify Add Department Group functionality
	@Test
	public void VerifytheUserViewFuctionality() throws Throwable {
		...
		we.waitAndClick(us.getViewButton());
