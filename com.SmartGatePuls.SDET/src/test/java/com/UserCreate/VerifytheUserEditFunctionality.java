...
public class VerifytheUserEditFunctionality extends BaseClass {

	@Test
	public void VerifytheUserEditFunctionality() throws Throwable {
		...
		// Verify the message
		Assert.assertTrue(actualMsg.contains("User updated successfully"),
