...
public class VerifytheAddUserFunctionality extends BaseClass {

	// TestNG test method to verify Add Department Group functionality
	@Test
	public void VerifytheAddUserFunctionality() throws Throwable {
		...
		//we.waitAndClick(us.getEmailId());
		
		//us.getEmailId().sendKeys(email);
