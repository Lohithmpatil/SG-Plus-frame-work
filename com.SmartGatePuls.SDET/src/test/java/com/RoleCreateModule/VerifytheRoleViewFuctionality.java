...
public class VerifytheRoleViewFuctionality extends BaseClass {

	@Test
	public void VerifytheRoleViewFuctionality() throws Throwable {
		...
		we.waitAndClick(rl.getViewButton());

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

		WebElement viewText = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[text()='view']")));
