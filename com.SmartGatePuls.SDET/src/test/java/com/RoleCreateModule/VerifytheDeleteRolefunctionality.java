...
public class VerifytheDeleteRolefunctionality extends BaseClass {

	@Test
	public void VerifytheDeleteRolefunctionality() throws Throwable {
		...
		we.waitAndClick(rl.getDeleteButton());

		we.waitAndClick(rl.getYesDeleteBtn());
		...
		// Verify the message
		Assert.assertTrue(actualMsg.contains("Role deleted successfully"),
