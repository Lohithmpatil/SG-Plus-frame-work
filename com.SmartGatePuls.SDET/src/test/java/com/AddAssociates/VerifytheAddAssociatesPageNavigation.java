...
public class VerifytheAddAssociatesPageNavigation extends BaseClass {
	...
	public void VerifytheAddAssociatesPageNavigation() throws Throwable {
		...
		Assert.assertTrue(cycleTimeHeader.isDisplayed(), "Settings/Add Associate header is not displayed");
	}
