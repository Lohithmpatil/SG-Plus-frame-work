...
public class VerifytheWeightedAvgCycleTime extends BaseClass{
	
@Test
	public void verifytheWeightedAvgCycleTime() throws Throwable {
		...
		System.out.println("Weighted Avg Cycle Time : " + weightedAvg);
}
}
