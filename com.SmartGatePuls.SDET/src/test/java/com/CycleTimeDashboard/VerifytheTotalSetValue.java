...
public class VerifytheTotalSetValue extends BaseClass {

	@Test
	public void verifytheTotalSetValue() throws Throwable {
		...
		String totalSetValue = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//th[contains(text(),'Total')]/following-sibling::th[1]")))
				.getText();

		System.out.println("Total Set Value: " + totalSetValue);
	}
}
