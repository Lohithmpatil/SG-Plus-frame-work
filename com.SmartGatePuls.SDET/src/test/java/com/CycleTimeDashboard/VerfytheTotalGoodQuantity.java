...
public class VerfytheTotalGoodQuantity extends BaseClass {

	@Test
	public void verifytheTotalGoodQuantity() throws Throwable {
		...
		String totalGoodQty = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//th[contains(text(),'Total')]/following-sibling::th[3]")))
				.getText();

		System.out.println("Total Good Qty: " + totalGoodQty);
	}
}
