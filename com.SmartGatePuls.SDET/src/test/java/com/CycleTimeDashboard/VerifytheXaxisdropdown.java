...
public class VerifytheXaxisdropdown  extends BaseClass{
	@Test
	public void VeirfytheAaxisdropdown() throws Throwable {
		...
		WebElement unitLocator = cd.getXaxisDropdown();
		WebElement dropdown =
		        wait.until(ExpectedConditions.elementToBeClickable(unitLocator));
