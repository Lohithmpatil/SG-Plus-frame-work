...
public class VerifytheBadQuantity extends BaseClass {
	
	@Test
	public void verifytheTotalBaDQuantity() throws Throwable {
		...
		String totalBadQty = wait.until(
			    ExpectedConditions.visibilityOfElementLocated(
			        By.xpath("//th[contains(text(),'Total')]/following-sibling::th[4]")))
			    .getText();

			System.out.println("Total Bad Qty: " + totalBadQty);
	}
}
