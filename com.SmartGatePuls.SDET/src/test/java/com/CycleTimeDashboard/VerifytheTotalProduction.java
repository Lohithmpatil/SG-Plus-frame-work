...
public class VerifytheTotalProduction  extends BaseClass{
	
	@Test
	public void verifytheTotalProduction() throws Throwable {
		...
		String totalProduction = wait.until(
			    ExpectedConditions.visibilityOfElementLocated(
			        By.xpath("//th[contains(text(),'Total')]/following-sibling::th[2]")))
			    .getText();
