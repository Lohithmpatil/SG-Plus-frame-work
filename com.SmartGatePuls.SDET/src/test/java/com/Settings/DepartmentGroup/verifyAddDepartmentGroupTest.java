...
public class verifyAddDepartmentGroupTest extends BaseClass {

	// TestNG test method to verify Add Department Group functionality
	@Test
	public void verifyAddDepartmentGroupTest() throws Throwable {
		 ...
		 * verifyDefaultMTTRMTBFSourceSelectionTest()
