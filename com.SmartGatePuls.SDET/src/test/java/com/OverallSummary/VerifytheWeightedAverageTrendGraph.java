...
public class VerifytheWeightedAverageTrendGraph extends BaseClass {
	@Test
	public void VerifytheWeightedAvaearageTrendGraph() throws Throwable {
		...
		WebElement graph = wait.until(ExpectedConditions.visibilityOfElementLocated(
		        By.id("lineGraph")));
