...
public class VerifytheSkuSummaryTable extends BaseClass {
	
	@Test
	public void VerifytheSkuSummaryTable() throws Throwable {
		...
		WebElement table = wait.until(ExpectedConditions.visibilityOfElementLocated(
		        By.xpath("(//table[contains(@class,'table')])[1]"))); // First table = SKU Summary
