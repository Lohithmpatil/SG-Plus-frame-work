...
public class VerifytheOverallSummaryPageNavigation extends BaseClass {

	@Test
	public void VerifytheOverallSummarypageNavigation() throws Throwable {
		...
		WebElement cycleTimeHeader = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//span[text()=\"Cycle Time/Overall Summary\"]")));

		Assert.assertTrue(cycleTimeHeader.isDisplayed(), "Cycle Time/Overall Summary pgae header is not displayed");
