...
public class VerifyShiftBViewDisplaysDataForDifferentShiftsTest extends BaseClass {

    // Test method to verify the navigation to Shift View page
    @Test
    public void VerifyShiftBViewDisplaysDataForDifferentShiftsTest() throws Throwable {
        ...
        we.select(ds.getShiftDropDown(), "B");
