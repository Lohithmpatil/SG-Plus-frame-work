...
public class VerifyShiftAViewDisplaysDataForDifferentShiftsTest extends BaseClass {

    // Test method to verify the navigation to Shift View page
    @Test
    public void VerifyShiftAViewDisplaysDataForDifferentShiftsTest() throws Throwable {
