...
public class VerifyProductionTypeDropdownFunctionalityTest extends BaseClass {
	// TestNG test method annotation
		@Test
		public void VerifyProductionTypeDropdownFunctionalityTest() throws Throwable {
			...
			we.select(re.getProductionTypedropdown(), "PCR");
