...
public class VerifytehOEETargetpageNavigation extends BaseClass {

	@Test
	public void verifytheOEETargetpageNavigation() throws Throwable {
        ...
        WebElement cycleTimeHeader = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//span[text()=\"Settings/OEE Target\"]")));

        Assert.assertTrue(cycleTimeHeader.isDisplayed(),
                "Settings/OEE Target header is not displayed");
	}
