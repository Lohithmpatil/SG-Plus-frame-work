...
public class VerifytheOEETargetEditFuntionality extends BaseClass {

	@Test
	public void VerifytheOEETargetEditFuntionality() throws Throwable {
		...
		we.waitAndClick(oe.getDots3Button());

		we.waitAndClick(oe.getEditButton());
		...
		Assert.assertEquals(actualMessage, "1 Equipment OEE target updated successfully",
