...
public class VerifytheMachinepotentiolLossgraph extends BaseClass {

	@Test
	public void VerifytheMachinepotentiolLossgraph() throws Throwable {
		...
		WebElement graphTitle = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='Machine Potential Loss Graph']")));

		Assert.assertTrue(graphTitle.isDisplayed(), "Machine Potential Loss Graph is not displayed.");
	}
}
