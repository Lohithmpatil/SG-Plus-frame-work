...
public class VerifytheWieghtedAveragesSetValueData extends BaseClass {
	

	@Test
	public void VerifytheWieghtedAveragesData() throws Throwable {
		...
		WebElement setValue = wait.until(
		        ExpectedConditions.visibilityOfElementLocated(
		                By.xpath("//*[name()='path' and contains(@aria-label,'Set Value')]")));

		System.out.println("Set Value : " + setValue.getAttribute("aria-label"));
	}
