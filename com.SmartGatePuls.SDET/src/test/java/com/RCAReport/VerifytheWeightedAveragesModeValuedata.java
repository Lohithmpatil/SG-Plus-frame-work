...
public class VerifytheWeightedAveragesModeValuedata extends BaseClass{
	...
	public void VerifytheWeightedAveragesModeValuedata() throws Throwable {
		...
		WebElement setValue = wait.until(
		        ExpectedConditions.visibilityOfElementLocated(
		                By.xpath("//*[name()='path' and contains(@aria-label,'Mode Value')]")));

		System.out.println("Mode Value : " + setValue.getAttribute("aria-label"));
	}
