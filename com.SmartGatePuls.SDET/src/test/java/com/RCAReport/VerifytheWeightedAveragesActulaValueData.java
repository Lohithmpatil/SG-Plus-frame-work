...
public class VerifytheWeightedAveragesActulaValueData extends BaseClass{
	
	@Test
	public void VerifytheWeightedAveragesActulaValueData() throws Throwable {
		...
		WebElement setValue = wait.until(
		        ExpectedConditions.visibilityOfElementLocated(
		                By.xpath("//*[name()='path' and contains(@aria-label,'Actual Value')]")));

		System.out.println("Actual Value : " + setValue.getAttribute("aria-label"));
	}
