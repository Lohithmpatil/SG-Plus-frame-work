...
public class VerifytheRCAReportPageNavigation extends BaseClass{

	
	@Test
	public void VerifytheRCAReportPageNavigation() throws Throwable {
        ...
        WebElement cycleTimeHeader = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//span[text()=\"Cycle Time/RCA Report\"]")));

        Assert.assertTrue(cycleTimeHeader.isDisplayed(),
                "Cycle Time/RCA Report header is not displayed");
