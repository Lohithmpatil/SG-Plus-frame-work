...
public class VerifytheTotalProductionData extends BaseClass{

	
	@Test
	public void VerifytheTotalProductionData() throws Throwable {
		...
		WebElement totalProduction = wait.until(
		        ExpectedConditions.visibilityOfElementLocated(
		                By.xpath("//span[contains(.,'Total Production')]")));
