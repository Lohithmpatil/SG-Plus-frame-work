...
public class VerifytheAggregatedSummaryTableisNotEmpty extends BaseClass {

	@Test
	public void VerifytheAggregatedSummaryTableisNotEmpty() throws Throwable {
		...
		for (int i = 0; i < rows.size(); i++) {
			...
			Assert.assertTrue(rows.size() > 0, "Aggregated Summary View table is empty.");
