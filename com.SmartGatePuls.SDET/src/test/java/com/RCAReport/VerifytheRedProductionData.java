...
public class VerifytheRedProductionData extends BaseClass {
	
	@Test
	public void VerifytheRedProductionData() throws Throwable {
		...
		WebElement totalProduction = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(.,'Red Production')]")));
